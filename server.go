...
func (s *matchService) serve(listen string) error {
	...
	mux.HandleFunc("/nodes/create", s.handleNodesCreate)
	mux.HandleFunc("/nodes/delete", s.handleNodesDelete)
	mux.HandleFunc("/nodes/rename", s.handleNodesRename)
	mux.HandleFunc("/routing/nodes", s.handleRoutingNodesList)
	mux.HandleFunc("/rulesets", s.handleRuleSetsList)
	mux.HandleFunc("/rulesets/create", s.handleRuleSetsCreate)
	mux.HandleFunc("/rulesets/update", s.handleRuleSetsUpdate)
	mux.HandleFunc("/rulesets/delete", s.handleRuleSetsDelete)
